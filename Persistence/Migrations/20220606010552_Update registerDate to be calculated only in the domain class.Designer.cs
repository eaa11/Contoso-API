...
namespace Contoso.API.Persistence.Migrations
{
    ...
    [Migration("20220606010552_Update registerDate to be calculated only in the domain class")]
    partial class UpdateregisterDatetobecalculatedonlyinthedomainclass
    {
